...
reserved for a Probe-stage sandbox left mid-cleanup pending reconciliation (`docs/design.md` §7)
— it is not one of the lane-envelope statuses and must not be used as a lane status.
