...
Guidance for Claude Code (and other AI coding agents) contributing to deja-vu — a Claude Agent
Skill that runs a structured prior-art hunt before custom code gets built. This mirrors
